...
{{-- @section('breadcrumb-section')
    ...
    <x-front.breadcrumb img_link="images/site/tour_img_1781765744.jpg">
        <h1 class="display-4 fw-bold text-light">About In~Africa Link</h1>
...
<div class="pt-5"></div>
        ...
        <div class="container">
            ...
            <div class="row  mb-5">
                <div class="col-lg-6">
                    ...
                    <p class="">
                        <strong>In~Africa Link was born from a simple belief:</strong>
                        Africa is not just a place to visit—it is a place to feel.
                    </p>
                ...
                <div class="col-lg-6">
                    <img src="{{ asset('images/site/about/about1.jpeg') }}" class="img-fluid rounded shadow"
                        alt="Mission">
                </div>
            </div>
 ...
 <div class="col-lg-6 order-lg-1">
                    <img src="{{ asset('images/site/about/about3.png') }}" class="img-fluid rounded shadow"
            ...
            <div class="bg-light rounded p-5 mb-5">
                ...
                <h3 class="fw-bold mb-4">
                    We are more Than a Tour Company
                </h3>
            ...
            <div class="text-center">
                ...
                <div class="col-lg-9 mx-auto">
                    ...
                    <p>
                        ...
                        our promise remains the same.   Because the greatest journey is not measured by the places you visit,
                        ...
                        <div class="col-lg-9 mx-auto">
                            ...
                            and connect them with the authentic heartbeat of Africa.  From breathtaking landscapes and vibrant cultures to meaningful local
    ...
    <section class="py-5">
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-3 me-2 mb-4 p-3  border rounded">
