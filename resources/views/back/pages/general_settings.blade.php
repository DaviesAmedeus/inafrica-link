...
@section('content')
    ...
    @push('scripts')
        <script>
            ...
            $('input[type="file"][name="site_light_mode_logo"]').ijaboViewer({
                preview: '#preview_site_light_mode_logo',
                ...
                onSuccess: function(message, element) {
                   ...
                   $('input[type="file"][name="site_dark_mode_logo"]').ijaboViewer({
                preview: '#preview_site_dark_mode_logo',
                imageShape: 'rectangular',
                allowedExtensions: ['png', 'jpg'],
                onErrorShape: function(message, element) {
                    alert(message)
            ...
            $('#updateLightModeLogoForm').submit(function(e) {
                e.preventDefault();
                var form = this;
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            if (data.status == 1) {
                                ...
                                $('img.site_light_mode_logo').each(function() {
