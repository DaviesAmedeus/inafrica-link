                ...
                <div class="pd-20">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <h6>Site Light mode logo</h6>
                            <div class="mb-2 mt-1" style="max-width: 200px">
                                <img wire:ignore src="" alt="" class="img-thumbnail"
                                    data-ijabo-default-img="{{ settings()?->site_light_mode_logo ? asset('images/site/' . settings()->site_light_mode_logo) : '' }}"
                                    id="preview_site_light_mode_logo">
                            </div>
                            <form action="{{ route('admin.update_light_mode_logo') }}" method="post"
                                enctype="multipart/form-data" id="updateLightModeLogoForm">
                                @csrf
                                <div class="pb-5">
                                    <input type="file" name="site_light_mode_logo" id="" class="form-control">
                        ...
                        <div class="col-md-4">
                            ...
                            <h6>Site dark mode logo</h6>
                            <div class="mb-2 mt-1" style="max-width: 200px">
                                <img wire:ignore src="" alt="" class="img-thumbnail"
                                    data-ijabo-default-img="{{ settings()?->site_dark_mode_logo  ? asset('images/site/' . settings()->site_dark_mode_logo) : '' }}"
                                    id="preview_site_dark_mode_logo">
                            </div>
                            <form action="{{ route('admin.update_dark_mode_logo') }}" method="post"
                                enctype="multipart/form-data" id="updateLogoForm">
                                @csrf
                                <div class="pb-5">
                                    <input type="file" name="site_dark_mode_logo" id="" class="form-control">
                                    <span class="text-danger ml-1"></span>
                                </div>
                                <button type="submit" class="btn btn-primary">Change logo</button>
                            </form>
